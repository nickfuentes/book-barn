  ...
  return (
    <div>
      ...
      <input
        ...
        value={bookTitle}
        name="title"
        onChange={titleHandleTextBoxChange}
      />
      ...
      <input
        ...
        value={bookGenre}
        name="genre"
        onChange={genreHandleTextBoxChange}
      />
      ...
      <input
        ...
        value={bookAuthor}
        name="author"
        onChange={authorHandleTextBoxChange}
      />
      ...
      <input
        ...
        value={bookYear}
        name="year"
        onChange={e => yearHandleTextBoxChange(e.target.value)}
      />
      ...
      <button color="primary" onClick={() => updateBook()}>
        UpdateBook
      </button>
    </div>
  )
